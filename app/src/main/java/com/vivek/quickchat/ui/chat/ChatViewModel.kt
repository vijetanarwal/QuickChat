...
import com.vijet.quickchat.model.Data
import com.vijet.quickchat.model.MessageBody
...
import com.vijet.quickchat.utils.encodeBase64
import com.vijet.quickchat.utils.getReadableDate
...
class ChatViewModel @Inject constructor(
    ...
    fun listenerAvailabilityOfReceiver(receiverId: String, availability:(Boolean,String,String,Long)->Unit){
        repository.listenerAvailabilityOfReceiver(receiverId
            ...
            if (value != null){
                isReceiverAvailable = value.getBoolean(Constant.KEY_IS_ONLINE) ?: false
                fcm = value.getString(Constant.KEY_FCM_TOKEN).toString()
                profileImage = value.getString(Constant.KEY_IMAGE).toString()
                lastSeen = value.getLong(Constant.KEY_LAST_SEEN) ?: 0L
            }
            availability(isReceiverAvailable, fcm, profileImage, lastSeen)
        }
    }
